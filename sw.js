const C='jp2026-v9';
const PAGES=['./','index.html','guide.html','jour-par-jour.html','journees.html','aujourdhui.html','villes.html','hotels.html','budget.html','manifest.webmanifest','theme.css','icon-192.png','icon-512.png'];

...
| `budget.html` | qui doit combien à l'autre, en global et sous chaque poste (les hôtels surtout), ce qu'il reste à payer, puis une ligne par dépense avec son payeur (Ilyès, Mathilde, moitié) |
...
node tools/verify.mjs         # 126 assertions
```
